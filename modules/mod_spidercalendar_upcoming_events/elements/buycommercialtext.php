...
class JFormFieldBuyCommercialtext extends JFormFieldText
{
	...
	<div style="font-size:16px;padding:20px; padding-right:50px;text-align:justify">
		<img src="../modules/mod_spidercalendar_upcoming_events/elements/header.png" border="0" alt="www.web-dorado.com" width="215" align="left">
<p>If you want to adjust the colors and the design of the upcoming events to the style of your website, that is not a problem either. Web-Dorado offers a full version of Spider Calendar.</P><br />
