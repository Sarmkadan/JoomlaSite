...
<table id='admintable_id'>
	<tr>
		<td>
			...
			<button style="font-weight: bold;height: 30px;width: 100px;background-color: #f4f4f4;border: 1px solid #d4d4d4;color: #606060;background-image: url(administrator/components/com_spidercalendar/elements/new.png);background-repeat: no-repeat;background-position: 4px 2px;"><?php echo JText::_('NEW_EVENT') ?></button>
			</a>
		</td>
		...
		<td>
			...
			<button style="font-weight: bold;height: 30px;width: 130px;background-color: #f4f4f4;border: 1px solid #d4d4d4;color: #606060;background-image: url(administrator/components/com_spidercalendar/elements/publish.png);background-repeat: no-repeat;background-position: 4px 2px;"><?php echo JText::_('PUBLISH_EVENT') ?></button>
			</a>
		</td>
		<td>	
			...
			<button style="font-weight: bold;height: 30px;width: 130px;background-color: #f4f4f4;border: 1px solid #d4d4d4;color: #606060;background-image: url(administrator/components/com_spidercalendar/elements/unpublish.png);background-repeat: no-repeat;background-position: 4px 2px;"><?php echo JText::_('UNPUBLISH_EVENT') ?></button>
			</a>	
		</td>
		...
		<td>	
			...
			<button style="font-weight: bold;height: 30px;width: 130px;background-color: #f4f4f4;border: 1px solid #d4d4d4;color: #606060;background-image: url(administrator/components/com_spidercalendar/elements/delete.png);background-repeat: no-repeat;background-position: 4px 3px;"><?php echo JText::_('DELETE_EVENT') ?></button>
			</a>
		</td>
	</tr>
</table>
...
<?php echo JText::_( 'TITLE' ); ?>:
 ...
 <img class="calendar" id="st_d_img" src="administrator/components/com_spidercalendar/elements/calendar.png" alt="calendario" style="position:relative;  top: 9px;left: -29px;" />
<?php echo JText::_( 'TO' ); ?>: 
...
<img class="calendar" id="en_d_img" src="administrator/components/com_spidercalendar/elements/calendar.png" alt="calendario" style="position:relative; top: 9px;left: -29px;" /> 
